...
class BaseTopicGenerator:
    ...
    def parse(self, text: str):
        ...
        next_start_index = text.find(
            start_keyword, start_index + len(start_keyword))
        while start_index != -1:
            ...
            description = text[end_index +
                               len(end_keyword): next_start_index].strip()
    ...
    def get_random_topic(self):
        ...
        logger.okay("Chosen topic: " +
                    self.topic_descriptions[rand_indx]["topic"])
    ...
    def choose_topic(self):
        ...
        logger.okay("Chosen topic: " +
                    self.topic_descriptions[chosen_indx]["topic"])
