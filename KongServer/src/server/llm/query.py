...
from .prompts import *
from .promptsv2 import GENERATE_REPORT
from .prompts_jinja import GEN_PARAGRAPH_FROM_TREE_JINJA
...
class GenParagraphFromSubtreeV2(BaseLLMQueryV2):
    """
    Generate an essay from the subtree outline and context
    """
    def __init__(self,
                 ...
                 model: str = "gpt3"):
        super().__init__(cache_policy=cache_policy, model=model, json_output=False)
        super().init_prompt(GEN_PARAGRAPH_FROM_TREE_JINJA, jinja=True, ancestor_context=ancestor_context, main_topic=main_topic)

### New_Demo support
class GenerateReport(BaseLLMQueryV2):
    """
    Generate an essay from the subtree outline and context
    """
    def __init__(self,
                 ...
                 model: str = "gpt3"):
        super().__init__(cache_policy=cache_policy, model=model, json_output=False)
        super().init_prompt(GENERATE_REPORT, tree=tree)