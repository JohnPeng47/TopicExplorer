...
from utils.helper import double_encode_json
...
class TopicsLLMQuery(BaseLLM):
    def __init__(self, curriculum: str, concept: str, description: str, number: int = 4, model: str = "gpt3"):
        ...
        super().__init__(GENERATE_TOPICS, curriculum=curriculum, description=description, concept=concept, num=number, model=model)
...
class SectionsLLMQuery(BaseLLM):
    def __init__(self, topic: str, description: str, number: int = 4):
        ...
        super().__init__(GENERATE_SECTIONS, topic=topic, description=description, schema=encoded_schema, num=number)
...
class ExpandLLMQuery(BaseLLM):
    def __init__(self, curriculum: str, section: str, number: int = 4):
        ...
        super().__init__(GENERATE_EXPAND, curriculum=curriculum, section=section, schema=encoded_schema, num=number)
