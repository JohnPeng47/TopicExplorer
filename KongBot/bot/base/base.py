...
from models import gpt3, gpt4, deterministic_openai_model
...
class BaseLLM:
    ...
    def init_prompt(self, template, **prompt_args):
        ...
        self.llm = LLMChain(
            prompt=self.prompt,
            llm = deterministic_openai_model if os.environ.get("OPENAI_DETERMINISTIC", None) == "1" else self.openai_model
        )
